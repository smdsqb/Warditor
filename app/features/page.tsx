...
const features = [
  ...
  { icon: '🔗', title: 'Deep Platform Integration', desc: 'Connect your YouTube, Reddit, Discord, Github, Spotify, Zoom and Google accounts for a level of detail that will genuinely make you uncomfortable.', detail: 'Instead of just "YouTube — 3.2 hours", Warditor can tell you which videos you watched, which subreddits you browsed, and which corners of the internet swallowed your evening.' },
