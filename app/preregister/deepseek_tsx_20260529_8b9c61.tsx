    ...
    <div className="min-h-screen relative overflow-hidden bg-[#0a0a0a] flex flex-col">
      ...
      <style>{`
        ...
        .glitch-wrap::before {
          ...
          animation: glitch1 0.5s steps(1) infinite;
          color: #ff6f61;
        }
        .glitch-wrap::after {
          left: -2px; opacity: 0.5;
          animation: glitch2 0.5s steps(1) infinite;
          color: #ff3022;
        }
        @keyframes glitch1 {
        ...
        .submit-btn:hover:not(:disabled) {
          background: #c8301f; transform: translateY(-1px);
          box-shadow: 0 8px 32px rgba(230,56,41,0.5); animation: none;
        }
        ...
        .changelog-dot {
          ...
          background: #e63829; box-shadow: 0 0 8px rgba(230,56,41,0.8);
        ...
        @media (max-width: 640px) { .form-card { border-radius: 20px; } }
      `}</style>
