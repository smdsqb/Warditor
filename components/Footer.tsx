    ...
    <footer className="relative bg-black text-white overflow-hidden">
      ...
      <style>{`
        ...
        .footer-divider {
          width: 100%;
          height: 1px;
          background: linear-gradient(to right, transparent, rgba(255,255,255,0.08) 30%, rgba(230,56,41,0.2) 50%, rgba(255,255,255,0.08) 70%, transparent);
        }
      `}</style>
        ...
        <div className="py-12 grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-6" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <div className="md:col-span-1 flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3">
              ...
              {/* Mail */}
              <a href="mailto:placeholder@warditor.com" className="social-icon" aria-label="Email">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
